...
def get_fusion_face_voice_accuracy(face_probability, voice_probablity, show_graphs = False):
    ...
    return str(fused_probabilityping.output['fused_probability'])


#print(get_fusion_face_voice_accuracy(float(str(39.70)), 35, 0))
...
#print("50 and 50: " + str(get_fusion_face_voice_accuracy(50, 50, 1)))
